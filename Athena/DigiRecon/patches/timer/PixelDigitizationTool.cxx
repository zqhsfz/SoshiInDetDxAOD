...
StatusCode PixelDigitizationTool::initialize()
{
 ...
 // check the input object name
  ...
  // timer
  m_timer_execute = new TH1D("Timer_PixelDigitizationTool", "Timer_PixelDigitizationTool", 100000, 0, 100000);
...
StatusCode PixelDigitizationTool::finalize() {
  ...
  // store timer histograms //
  TFile* fOutput = new TFile("Timer_PixelDigitizationTool.root", "RECREATE");
